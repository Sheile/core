...
- apt-transport-https 1.2.29ubuntu0  
...
1. 別ターミナル画面を開き、表示されたDNS TXT recordを環境変数DNS_TXTに設定
...
1. 元ターミナルに戻り、Enterキーを押下し、Let's encryptの認証が成功したことを確認
...
1. MQTT__iotagentの環境変数をrb-config.jsに埋め込む
...
1. AKSにiotagent-ul-minikube-serviceのインストール
...
1. AKSにcygnus-mongo-deploymentのインストール
